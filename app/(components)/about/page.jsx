  ...
  return (
    <div>
      ...
      <TracingBeam className="px-6">
        ...
        <h1 className="font-extrabold text-center text-4xl">Why Choose LiveBeta</h1><br />
        <ol className="list-decimal">
          <li>
          ...
          <br />
          <li>
          <h1 className="font-bold">Community Building:</h1> LiveBeta fosters a sense of community by connecting like-minded individuals who share common travel routes and interests.
          </li>
          <br />
        ...
        At LiveBeta, our mission is to make transportation more sustainable and accessible for everyone. By promoting the sharing economy and encouraging collaborative travel practices, we aim to create a greener and more connected world.

        <br />
        <br />
        <h2 className="font-semibold text-xl text-center">Join the LiveBeta Community Today!</h2>
        <br />
